...
export const DESIGN_SYSTEM = {
  title: 'Ardi Design System',
  description:
    'Foundations, components, and patterns for Ardi — the autonomous penetration testing platform. Dark navy canvas, electric-cyan primary, Inter + JetBrains Mono.',
} as const;
