# Migrating web UI to Ardi Design System

Read `artifacts/ardi-ds/docs/AGENTS.md` and
`artifacts/ardi-ds/docs/consuming-web.md` first. Use this guide
...
- `@/components/ui/<name>` →
  `@workspace/ardi-ds/components/ui/<name>`
- `@/lib/utils` (`cn`) → `@workspace/ardi-ds/lib/utils`
- `@/hooks/use-toast` → `@workspace/ardi-ds/hooks/use-toast`
