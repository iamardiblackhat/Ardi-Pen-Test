# Consuming Ardi Design System in web apps

Read `artifacts/ardi-ds/docs/AGENTS.md` first. This guide covers
...
`artifacts/ardi-ds/docs/migrating-web.md` before writing UI.
...
```css
@import "@workspace/ardi-ds/styles.css";
```
...
`node_modules/@workspace/ardi-ds/src/components` to `content`.
...
import {
  toast,
  useToast,
} from "@workspace/ardi-ds/hooks/use-toast";
```
...
`@workspace/ardi-ds/components/ui/button`. Run the app's typecheck
