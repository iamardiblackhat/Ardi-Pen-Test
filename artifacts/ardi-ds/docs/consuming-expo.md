# Consuming Ardi Design System in Expo apps

Read `artifacts/ardi-ds/docs/AGENTS.md` first. React Native does
...
`artifacts/ardi-ds/docs/migrating-expo.md` before writing UI.
...
```tsx
import { tokens } from "@workspace/ardi-ds/tokens";
...
```tsx
import { nativeTheme } from "@workspace/ardi-ds/lib/native-theme";
import { useColors } from "@workspace/ardi-ds/hooks/use-colors";
import { useDesignSystemFonts } from "@workspace/ardi-ds/hooks/use-fonts";
```
...
```tsx
import { Badge } from "@workspace/ardi-ds/components/native/badge";
import { Button } from "@workspace/ardi-ds/components/native/button";
import { Card } from "@workspace/ardi-ds/components/native/card";
```
...
Import and render
`@workspace/ardi-ds/components/native/button`, then run Expo
