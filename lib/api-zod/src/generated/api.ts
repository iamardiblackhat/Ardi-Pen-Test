 ...
 */
export const GetComplianceFrameworksResponseItem = zod.object({
  "id": zod.string(),
  "name": zod.string(),
  "version": zod.string(),
  "score": zod.number(),
  "controlsPassed": zod.number(),
  "controlsFailed": zod.number(),
  "controlsTotal": zod.number(),
  "lastAssessedAt": zod.string().nullable(),
  "status": zod.enum(['compliant', 'non_compliant', 'partial', 'not_assessed']).optional()
})
export const GetComplianceFrameworksResponse = zod.array(GetComplianceFrameworksResponseItem)
...
export const GetComplianceFrameworkResponse = zod.object({
  ...
  "id": zod.string(),
  "name": zod.string(),
  "status": zod.enum(['passed', 'failed', 'partial', 'not_assessed']),
  "category": zod.string(),
  "findings": zod.array(zod.number()).optional(),
  "description": zod.string().optional()
}))
})
